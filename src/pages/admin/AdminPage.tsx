...
import { Plus, Trash2, Edit2, Check, X, Loader2, ArrowLeft, ArrowUpDown } from 'lucide-react'
                  ...
                  <TableRow key={wf.id}>
                    {editingId === wf.id ? (
                      <>
                        ...
                        <TableCell className="text-right space-x-1">
                          <Button
                            ...
                            disabled={!editRole || !editStep || !editStageOrder || !editCategory}
                          >
                      ...
                      <>
                        ...
                        <TableCell className="font-medium text-center">{wf.step || 1}</TableCell>
